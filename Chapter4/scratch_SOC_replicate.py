...
csv_filename = f'2Timestep_scaledown_{scaledown}Month{month}_rate_c{charging_rate}_rate_d{discharging_rate}_WIND{capacity}000MW.csv'
...
for t in df_cars_month.index[1:]:
    ...
    if t >= start_time and t < end_time:
        ...
        if alpha>1: ## adding new cars with similar mobility patterns and SOC in good range
            ...
            # create a dictionary with the soc of all the non relevant cars ( driving, blocked, free)
