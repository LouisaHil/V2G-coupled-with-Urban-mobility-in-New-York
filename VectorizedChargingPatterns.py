...
start_time = '2019-04-1 00:00:00'
start_datetime = datetime.strptime(start_time, '%Y-%m-%d %H:%M:%S')
end_time = '2019-04-30 23:45:00'
end_datetime = datetime.strptime(end_time, '%Y-%m-%d %H:%M:%S')

## 2013 ##change here for new month
start = datetime(2013, 4, 1, 0, 0)
end = datetime(2013, 4, 30, 23, 30)
...
df_taxi = pd.read_csv('new_NbofEvs_4.csv', index_col=0, parse_dates=True)
...
def createdischargeavail(medallion, T_dopt,a,b,c,d):
    ...
    date_range = pd.date_range(start='2013-04-01 00:00:00', end='2013-04-30 23:45:00', freq='15T')
...
all_medaillon_df.to_excel("4Medaillonlist.xlsx", index=False)
...
scaled_medaillon_df.to_excel("4rows_scaled.xlsx", index=False)
...
summed_rows.to_excel("4summed_rows_scaled.xlsx", index=False)